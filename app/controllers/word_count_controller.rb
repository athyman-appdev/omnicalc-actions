class WordCountController < ApplicationController
  def word_count
    ...
    # ================================================================================
    text_for_analysis = @text.downcase
    special_word_for_analysis = @special_word.downcase
    special_word_count = text_for_analysis.scan(special_word_for_analysis).count
